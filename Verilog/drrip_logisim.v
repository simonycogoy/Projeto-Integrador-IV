...
module drrip_logisim (
    ...
    ////////////////////////////////////////////////////////////
    // 5) Valor de RRPV em caso de hit
    //    SRRIP => 0, BRRIP => 2
    ////////////////////////////////////////////////////////////
    assign rrpv0_hit = hit0 ? (SRRIP_ou_BRRIP ? 2'd0 : 2'd2) : 2'd0;
    assign rrpv1_hit = hit1 ? (SRRIP_ou_BRRIP ? 2'd0 : 2'd2) : 2'd0;
    assign rrpv2_hit = hit2 ? (SRRIP_ou_BRRIP ? 2'd0 : 2'd2) : 2'd0;
    assign rrpv3_hit = hit3 ? (SRRIP_ou_BRRIP ? 2'd0 : 2'd2) : 2'd0;
    ...
    ////////////////////////////////////////////////////////////
    // 8) Selecao da vitima
    //    Prioridade: invalid0 > invalid1 > invalid2 > invalid3 >
    //                rrpv0_igual_3 > rrpv1_igual_3 > rrpv2_igual_3 > rrpv3_igual_3
    ////////////////////////////////////////////////////////////
    ...
    // Codifica a via vitima em 2 bits
    ...
    ////////////////////////////////////////////////////////////
    // 9) RRPV de insercao: SRRIP => 0, BRRIP => 2
    ////////////////////////////////////////////////////////////
    assign insercao_rrpv = SRRIP_ou_BRRIP ? 2'd0 : 2'd2;
    ...
    //    Prioridade: hit > miss_vitima > envelhecer > manter
    ////////////////////////////////////////////////////////////
    assign prox_rrpv0 = hit0 ? rrpv0_hit :
                        (miss & vitima0) ? insercao_rrpv :
                        (miss & envelhecer_rrpvs & rrpv0_menor_3) ? rrpv0_mais_1 :
                        rrpv0;

    assign prox_rrpv1 = hit1 ? rrpv1_hit :
                        (miss & vitima1) ? insercao_rrpv :
                        (miss & envelhecer_rrpvs & rrpv1_menor_3) ? rrpv1_mais_1 :
                        rrpv1;

    assign prox_rrpv2 = hit2 ? rrpv2_hit :
                        (miss & vitima2) ? insercao_rrpv :
                        (miss & envelhecer_rrpvs & rrpv2_menor_3) ? rrpv2_mais_1 :
                        rrpv2;

    assign prox_rrpv3 = hit3 ? rrpv3_hit :
                        (miss & vitima3) ? insercao_rrpv :
                        (miss & envelhecer_rrpvs & rrpv3_menor_3) ? rrpv3_mais_1 :
                        rrpv3;

    // Saidas adicionais de proximo RRPV
    ...
    ////////////////////////////////////////////////////////////
    // 12) Logica sequencial - atualizacao na borda de subida
    ////////////////////////////////////////////////////////////
